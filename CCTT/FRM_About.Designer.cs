namespace CCTT
{
    partial class FRM_About
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBoxDescription.Text = "مشروع تطوير منضومة دراسة والامتحانات الخاص بادورات ودبلوم التخصصي الصالح لكلية تق" +
    "نية الحاسوب طرابلس \r\n\r\nالقائيمن علي هذا  المشروع حاتم محمد أبو جعفر وعبد الرحيم " +
    "عبد الناصر ترفاس\r\n";
            // 
            // labelCompanyName
            // 
